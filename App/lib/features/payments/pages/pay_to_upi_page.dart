...
class PayToUpiIdPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PayToUpiIdPage> createState() => _PayToUpiIdPageState();
}

class _PayToUpiIdPageState extends ConsumerState<PayToUpiIdPage> {
  ...
  Future<void> _searchUser() async {
    ...
    final user = await ref.read(paymentRepositoryProvider).searchByUpiId(upiId);
    if (!mounted) return;
    setState(() {
      _loading = false;
      if (user != null) {
  ...
  Future<void> _processPayment() async {
    ...
    final result = await ref.read(paymentRepositoryProvider).sendByUpiId(
          senderPhone: senderPhone,
          receiverUpi: _upiController.text.trim(),
          amount: amount,

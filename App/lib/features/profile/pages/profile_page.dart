...
class _NotificationsSheetState extends ConsumerState<_NotificationsSheet> {
  ...
  void initState() {
    ...
    _payments = session.flag('notif_payments', defaultValue: true);
    _requests = session.flag('notif_requests', defaultValue: true);
    _promotions = session.flag('notif_promotions', defaultValue: false);
  }

  Future<void> _save(String key, bool val) =>
      ref.read(sessionStoreProvider).setFlag(key, val);
